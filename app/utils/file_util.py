...
class FileUtil:
    ...
    async def validate_file(file: UploadFile):
        ...
        # 1.5. Validacion tamaño maximo
        if len(content) > Constantes.MAX_FILE_SIZE:
             raise AppBaseException(message=f"El archivo '{file.filename}' excede el tamaño máximo permitido de {Constantes.MAX_FILE_SIZE_TEXT}.")
