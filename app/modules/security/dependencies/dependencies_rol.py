...
from app.modules.security.repository.impl.rol_repository_impl import RolRepositoryImpl
from app.modules.security.service.impl.rol_service_impl import RolServiceImpl
